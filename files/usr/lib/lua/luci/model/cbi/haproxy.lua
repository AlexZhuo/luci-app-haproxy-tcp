...
m=Map("haproxy",translate("HAProxy"),translate("HAProxy能够检测SS服务器的联通情况，从而实现负载均衡和高可用的功能，支持主备用服务器宕机自动切换，并且你可以设置多个主服务器用于分流，设置每个分流节点的流量比例等。前提条件是你的所有ss服务器的【加密方式】和【密码】必须一致。使用方法：只要把下面配置文件的倒数几行改成你的服务器ip地址和端口，然后开启ShadowsocksR/SS/Redsocks服务，将服务器地址填写为【127.0.0.1】，端口【2222】，其他参数和之前一样即可，你可以通过访问【路由器的IP:1111/haproxy】输入用户名admin，密码root来观察各节点健康状况，红色为宕机，绿色正常,使用说明请<a href='http://www.right.com.cn/forum/thread-198649-1-1.html'>点击这里</a>") .. "<br><br>后台监控页面：<a href='http://" .. router_ip .. ":1111/haproxy'>" .. router_ip .. ":1111/haproxy</a>  用户名admin，密码root" .. "<br><br>状态 - " .. state_msg)
